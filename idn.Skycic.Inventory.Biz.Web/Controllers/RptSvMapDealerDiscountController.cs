...
{
    public class RptSvMapDealerDiscountController : ApiControllerBase
	{
		[AcceptVerbs("POST")]
		public ServiceResult<RT_Map_DealerDiscount> WA_RptSv_Map_DealerDiscount_Get(RQ_Map_DealerDiscount objRQ_Map_DealerDiscount)
		{
			#region // Temp:
			...
			string strControllerName = "WA_RptSv_Map_DealerDiscount_Get";
			string strErrorCodeDefault = "WA_RptSv_Map_DealerDiscount_Get";
			...
			try
			{
				...
				#region // Process:
				//
				mdsReturn = _biz.WAS_RptSv_Map_DealerDiscount_Get(
					ref alParamsCoupleError // alParamsCoupleError
