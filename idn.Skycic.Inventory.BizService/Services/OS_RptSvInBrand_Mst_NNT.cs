...
{
	public class OS_RptSvInBrand_Mst_NNTService : ClientServiceBase<OS_RptSvInBrand_Mst_NNTService>
	{
		public static OS_RptSvInBrand_Mst_NNTService Instance
		{
			get
			{
				return GetInstance<OS_RptSvInBrand_Mst_NNTService>();
			}
		}
