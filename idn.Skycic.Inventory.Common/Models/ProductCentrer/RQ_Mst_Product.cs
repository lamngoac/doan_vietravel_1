...
{
	public class RQ_Mst_Product : WARQBase
	{
		public string Rt_Cols_Mst_Product { get; set; }

		public string Rt_Cols_Mst_ProductImages { get; set; }

		public string Rt_Cols_Mst_ProductFiles { get; set; }

		public string Rt_Cols_Prd_BOM { get; set; }

		public string Rt_Cols_Prd_Attribute { get; set; }
