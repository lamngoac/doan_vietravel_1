...
{
    public class Rpt_Inv_InventoryBalance_StorageTimeUI : Rpt_Inv_InventoryBalance_StorageTime
    {
        public List<Rpt_Inv_InventoryBalance_StorageTimeUI> ListRpt_Inv_InventoryBalance_StorageTimeUIChild { get; set; }
    }

    public class Rpt_Inv_InventoryBalance_StorageTimePrint
    {
        ...
        public List<Rpt_Inv_InventoryBalance_StorageTimeUI> Lst_Rpt_Inv_InventoryBalance_StorageTimeUI { get; set; }
    }

    public class Rpt_Inv_InventoryBalance_StorageTimeReportServer
    {
        public object NNTFullName { get; set; }
        public object NNTAddress { get; set; }
        public object NNTPhone { get; set; }
        ...
        public object LogoFilePath { get; set; }
        public List<Rpt_Inv_InventoryBalance_StorageTimeDtlReportServer> DataTable { get; set; }
    }

    public class Rpt_Inv_InventoryBalance_StorageTimeDtlReportServer
    {
        public object Idx { get; set; }
